...
@Excel("Contribution导入")
public class ContributionImport{

    private static final long serialVersionUID = 1L;
    @ApiModelProperty(value = "投稿id")
    @ExcelField(value = "投稿id", required = true, comment = "请填写投稿id", width=150)
    ...
    @ExcelField(value = "作者姓名", required = true, comment = "请填写作者姓名", width=150)
    private String authorName;

    @ApiModelProperty(value = "稿件标题")
    @ExcelField(value = "稿件标题", required = true, comment = "请填写稿件标题", width=150)
    private String contributionName;

    @ApiModelProperty(value = "发送栏目")
    @ExcelField(value = "发送栏目", required = true, comment = "请填写发送栏目", width=150)
    private String submitColumn;

    @ApiModelProperty(value = "审核状态")
    @ExcelField(value = "审核状态", required = true, comment = "请填写审核状态", width=150)
    private Integer submitStatus;

    @ApiModelProperty(value = "新闻信息ID")
    @ExcelField(value = "新闻信息ID", required = true, comment = "请填写新闻信息ID", width=150)
