...
@Excel("LinkManage导入")
public class LinkManageImport{

    private static final long serialVersionUID = 1L;
    @ApiModelProperty(value = "链接主键")
    @ExcelField(value = "链接主键", required = true, comment = "请填写链接主键", width=150)
    ...
    @ExcelField(value = "链接名称", required = true, comment = "请填写链接名称", width=150)
    private String linkName;

    @ApiModelProperty(value = "链接地址")
    @ExcelField(value = "链接地址", required = true, comment = "请填写链接地址", width=150)
    private String linkUrl;

    @ApiModelProperty(value = "所属分类")
    @ExcelField(value = "所属分类", required = true, comment = "请填写所属分类", width=150)
    private String linkCategory;

    @ApiModelProperty(value = "所属图片")
    @ExcelField(value = "所属图片", required = true, comment = "请填写所属图片", width=150)
