...
public class NewsInfoExport{
    ...
    @ExcelField(value = "一级分类", width=150)
    private String firstLevel;

    @ApiModelProperty(value = "二级分类")
    @ExcelField(value = "二级分类", width=150)
    private String secondLevel;

    @ApiModelProperty(value = "地区")
    @ExcelField(value = "地区", width=150)
    private String region;

    @ApiModelProperty(value = "新闻名称")
    @ExcelField(value = "新闻名称", width=150)
    private String newsName;

    @ApiModelProperty(value = "新闻来源")
    @ExcelField(value = "新闻来源", width=150)
    private String newsSource;

    @ApiModelProperty(value = "记者ID")
    @ExcelField(value = "记者ID", width=150)
    private String newsmanId;

    @ApiModelProperty(value = "记者")
    @ExcelField(value = "记者", width=150)
    private String newsman;

    @ApiModelProperty(value = "新闻点击率")
    @ExcelField(value = "新闻点击率", width=150)
    private Integer newsClickRate;

    @ApiModelProperty(value = "简介")
    @ExcelField(value = "简介", width=150)
    private String introduction;

    @ApiModelProperty(value = "图片地址")
    @ExcelField(value = "图片地址", width=150)
    private String imageUrl;

    @ApiModelProperty(value = "视频地址")
    @ExcelField(value = "视频地址", width=150)
    private String videoUrl;

    @ApiModelProperty(value = "新闻内容")
    @ExcelField(value = "新闻内容", width=150)
