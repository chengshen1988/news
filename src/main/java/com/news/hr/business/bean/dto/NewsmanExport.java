...
public class NewsmanExport{
    ...
    @ExcelField(value = "记者姓名", width=150)
    private String newsmanName;

    @ApiModelProperty(value = "性别")
    @ExcelField(value = "性别", width=150)
    private String gender;

    @ApiModelProperty(value = "记者证号码")
    @ExcelField(value = "记者证号码", width=150)
    private String cardNumber;

    @ApiModelProperty(value = "身份证号码")
    @ExcelField(value = "身份证号码", width=150)
    private String idCardNo;

    @ApiModelProperty(value = "单位名称")
    @ExcelField(value = "单位名称", width=150)
    private String unitName;

    @ApiModelProperty(value = "职务")
    @ExcelField(value = "职务", width=150)
    private String duty;

    @ApiModelProperty(value = "发证日期")
    @ExcelField(value = "发证日期", width=150)
    private LocalDateTime issueDate;

    @ApiModelProperty(value = "证件照片")
    @ExcelField(value = "证件照片", width=150)
    private String passportPhoto;

    @ApiModelProperty(value = "记者简历")
    @ExcelField(value = "记者简历", width=150)
