...
public interface ContentService extends IService<Content> {
    ...
    * @return 影响记录数
    */
    Integer save(ContentForm record);
    ...
    * @return 影响记录数
    */
    Integer updateById(ContentForm record);
    ...
    * @return
    */
    IPage<ContentVo> selectPage(ContentQuery contentQuery);
     ...
     * @return
     */
    List<ContentVo> selectList(ContentQuery contentQuery);
    ...
    * @param contentQuery 前台传值的query对象
    */
    QueryWrapper<Content> getQueryWrapper(QueryWrapper<Content> queryWrapper,ContentQuery contentQuery);
