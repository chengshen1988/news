...
public interface EnterpriseService extends IService<Enterprise> {
    ...
    * @return 影响记录数
    */
    Integer save(EnterpriseForm record);
    ...
    * @return 影响记录数
    */
    Integer updateById(EnterpriseForm record);
    ...
    * @return 信息对象
    */
    EnterpriseVo selectById(String id);
    ...
    * @return
    */
    IPage<EnterpriseVo> selectPage(EnterpriseQuery enterpriseQuery);
     ...
     * @return
     */
    List<EnterpriseVo> selectList(EnterpriseQuery enterpriseQuery);
    ...
    * @param enterpriseQuery 前台传值的query对象
    */
    QueryWrapper<Enterprise> getQueryWrapper(QueryWrapper<Enterprise> queryWrapper,EnterpriseQuery enterpriseQuery);
