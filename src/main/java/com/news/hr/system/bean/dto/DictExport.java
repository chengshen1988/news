...
public class DictExport{
    ...
    @ExcelField(value = "数据字典Id", width=150)
    ...
    @ExcelField(value = "是否叶子节电", width=150)
    private Integer isLeaf;

    @ApiModelProperty(value = "类型（分类、值）")
    @ExcelField(value = "类型（分类、值）", width=150)
    private String dictKind;

    @ApiModelProperty(value = "显示值")
    @ExcelField(value = "显示值", width=150)
    private String dictDisplay;

    @ApiModelProperty(value = "实际值")
    @ExcelField(value = "实际值", width=150)
