...
public class FileImport{
    ...
    @ExcelField(value = "文件Id", required = true, comment = "请填写文件Id", width=150)
    ...
    @ExcelField(value = "目录Id", required = true, comment = "请填写目录Id", width=150)
    private String directoryId;

    @ApiModelProperty(value = "业务类型")
    @ExcelField(value = "业务类型", required = true, comment = "请填写业务类型", width=150)
    private String businessType;

    @ApiModelProperty(value = "业务ID")
    @ExcelField(value = "业务ID", required = true, comment = "请填写业务ID", width=150)
    private String businessId;

    @ApiModelProperty(value = "文件名")
    @ExcelField(value = "文件名", required = true, comment = "请填写文件名", width=150)
    private String fileName;

    @ApiModelProperty(value = "文件编码")
    @ExcelField(value = "文件编码", required = true, comment = "请填写文件编码", width=150)
    private String fileCode;

    @ApiModelProperty(value = "文件大小(K)")
    @ExcelField(value = "文件大小(K)", required = true, comment = "请填写文件大小(K)", width=150)
    private Float fileSize;

    @ApiModelProperty(value = "文件类别（业务、消息……）")
    @ExcelField(value = "文件类别（业务、消息……）", required = true, comment = "请填写文件类别（业务、消息……）", width=150)
    private String fileKind;

    @ApiModelProperty(value = "文件类型(docx,xlsx,jpb)")
    @ExcelField(value = "文件类型(docx,xlsx,jpb)", required = true, comment = "请填写文件类型(docx,xlsx,jpb)", width=150)
    private String fileType;

    @ApiModelProperty(value = "存储")
    @ExcelField(value = "存储", required = true, comment = "请填写存储", width=150)
    private String fileStore;

    @ApiModelProperty(value = "转换后路径")
    @ExcelField(value = "转换后路径", required = true, comment = "请填写转换后路径", width=150)
