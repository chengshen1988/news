...
public class GroupImport{
    ...
    @ExcelField(value = "用户组Id", required = true, comment = "请填写用户组Id", width=150)
    ...
    @ExcelField(value = "所属组织机构编码", required = true, comment = "请填写所属组织机构编码", width=150)
    private String orgCode;

    @ApiModelProperty(value = "用户组名称")
    @ExcelField(value = "用户组名称", required = true, comment = "请填写用户组名称", width=150)
    private String groupName;

    @ApiModelProperty(value = "用户组编码")
    @ExcelField(value = "用户组编码", required = true, comment = "请填写用户组编码", width=150)
