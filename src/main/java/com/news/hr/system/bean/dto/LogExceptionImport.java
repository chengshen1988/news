...
@Excel("LogException导入")
public class LogExceptionImport{

    private static final long serialVersionUID = 1L;
    @ApiModelProperty(value = "异常Id")
    @ExcelField(value = "异常Id", required = true, comment = "请填写异常Id", width=150)
    ...
    @ExcelField(value = "请求数据", required = true, comment = "请填写请求数据", width=150)
    private String data;

    @ApiModelProperty(value = "错误提示")
    @ExcelField(value = "错误提示", required = true, comment = "请填写错误提示", width=150)
    private String message;

    @ApiModelProperty(value = "错误信息")
    @ExcelField(value = "错误信息", required = true, comment = "请填写错误信息", width=150)
