...
public class MenuExport{
    ...
    @ExcelField(value = "父级Id", width=150)
    private String menuParent;

    @ApiModelProperty(value = "菜单路径")
    @ExcelField(value = "菜单路径", width=150)
    private String menuPath;

    @ApiModelProperty(value = "级别")
    @ExcelField(value = "级别", width=150)
    ...
    @ExcelField(value = "菜单类型", width=150)
    private String menuKind;

    @ApiModelProperty(value = "菜单名称")
    @ExcelField(value = "菜单名称", width=150)
    private String menuName;

    @ApiModelProperty(value = "菜单别名")
    @ExcelField(value = "菜单别名", width=150)
    private String menuNameAlias;

    @ApiModelProperty(value = "菜单编码")
    @ExcelField(value = "菜单编码", width=150)
    private String menuCode;

    @ApiModelProperty(value = "菜单业务")
    @ExcelField(value = "菜单业务", width=150)
    ...
    @ExcelField(value = "菜单权限配置（具体对应类似于shiro permission）", width=150)
