...
public class MessageImport{
    ...
    @ExcelField(value = "创建用户的机构编码", required = true, comment = "请填写创建用户的机构编码", width=150)
    private String cUnitId;

    @ApiModelProperty(value = "创建用户的岗位编码")
    @ExcelField(value = "创建用户的岗位编码", required = true, comment = "请填写创建用户的岗位编码", width=150)
    ...
    @ExcelField(value = "消息类别", required = true, comment = "请填写消息类别", width=150)
    private String messageKind;

    @ApiModelProperty(value = "消息主题")
    @ExcelField(value = "消息主题", required = true, comment = "请填写消息主题", width=150)
    private String messageTitle;

    @ApiModelProperty(value = "消息内容")
    @ExcelField(value = "消息内容", required = true, comment = "请填写消息内容", width=150)
