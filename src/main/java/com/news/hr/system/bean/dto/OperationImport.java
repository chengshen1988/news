...
public class OperationImport{
    ...
    @ExcelField(value = "操作Id", required = true, comment = "请填写操作Id", width=150)
    ...
    @ExcelField(value = "操作类型", required = true, comment = "请填写操作类型", width=150)
    private String operationKind;

    @ApiModelProperty(value = "操作名称")
    @ExcelField(value = "操作名称", required = true, comment = "请填写操作名称", width=150)
    private String operationName;

    @ApiModelProperty(value = "操作编码")
    @ExcelField(value = "操作编码", required = true, comment = "请填写操作编码", width=150)
    private String operationCode;

    @ApiModelProperty(value = "页面标识")
    @ExcelField(value = "页面标识", required = true, comment = "请填写页面标识", width=150)
    private String pageKey;

    @ApiModelProperty(value = "操作权限")
    @ExcelField(value = "操作权限", required = true, comment = "请填写操作权限", width=150)
