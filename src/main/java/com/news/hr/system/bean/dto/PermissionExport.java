...
public class PermissionExport{
    ...
    @ExcelField(value = "权限id", width=150)
    private Integer permissionId;

    @ApiModelProperty(value = "权限类型（菜单、操作、数据）")
    @ExcelField(value = "权限类型（菜单、操作、数据）", width=150)
    ...
    @ExcelField(value = "资源id", width=150)
    private String resourceId;

    @ApiModelProperty(value = "资源标识")
    @ExcelField(value = "资源标识", width=150)
    private String resourceKey;

    @ApiModelProperty(value = "资源名称")
    @ExcelField(value = "资源名称", width=150)
    private String resourceName;

    @ApiModelProperty(value = "资源权限")
    @ExcelField(value = "资源权限", width=150)
    private String resourceAuth;

    @ApiModelProperty(value = "公式")
    @ExcelField(value = "公式", width=150)
    private String formula;

    @ApiModelProperty(value = "资源值")
    @ExcelField(value = "资源值", width=150)
