...
public class AccessLogController {
    ...
    * @return 是否添加成功
    */
    @ApiOperation(value = "保存数据", notes = "保存数据到AccessLog")
    ...
    public ReturnModel save(@RequestBody AccessLogForm accessLogForm) {
        ...
        return ReturnModel.newSuccessInstance(accessLogForm);
    }
     ...
     * @return 是否删除成功
     */
    @ApiOperation(value = "删除数据", notes = "根据主键id删除AccessLog数据")
    @PostMapping(value = "/deleteById", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ReturnModel deleteById(@RequestParam(required = true, value = "accessLogId") String accessLogId) {
    ...
    * @return 是否更改成功
    */
    @ApiOperation(value = "更新数据", notes = "根据主键id更新AccessLog数据")
    ...
    * @return 查询结果
    */
    @ApiOperation(value = "获取单条数据", notes = "根据主键id获取AccessLog数据")
    @GetMapping(value = "/selectById", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ReturnModel selectById(@RequestParam(required = true, value = "accessLogId") String accessLogId) {
     ...
     * @return
     */
    @ApiOperation(value = "分页获取所有accessLog信息", notes = "获取所有accessLog信息")
    @ApiImplicitParams({
