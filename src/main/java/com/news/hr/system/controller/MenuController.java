...
public class MenuController {
    ...
    */
     ...
     * @return 是否删除成功
     */
    @ApiOperation(value = "删除数据", notes = "根据主键id删除Menu数据")
    @PostMapping(value = "/deleteById", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ReturnModel deleteById(@RequestParam(required = true, value = "menuId") String menuId) {
    ...
    */
    ...
    public ReturnModel selectById(@RequestParam(required = true, value = "menuId") String menuId) {
     ...
     * @return
     */
    @ApiOperation(value = "分页获取所有menu信息", notes = "获取所有menu信息")
    @ApiImplicitParams({
