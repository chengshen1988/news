...
public class OperationController {
    ...
    */
    @ApiOperation(value = "保存数据", notes = "保存数据到Operation",httpMethod = "POST")
     ...
     */
    @ApiOperation(value = "删除数据", notes = "根据主键id删除Operation数据",httpMethod = "DELETE")
    @DeleteMapping(value = "/deleteById/operationId", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ReturnModel deleteById(@ApiParam(name = "operationId",value = "operation主键id")
    ...
    */
    @ApiOperation(value = "更新数据", notes = "根据主键id更新Operation数据",httpMethod = "PUT")
    @PutMapping(value = "/updateById/operationId", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    */
    @ApiOperation(value = "获取单条数据", notes = "根据主键id获取Operation数据",httpMethod = "GET")
    @GetMapping(value = "/selectById/operationId", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ReturnModel selectById(@RequestParam(value = "operationId")  String operationId) {
     ...
     */
    @ApiOperation(value = "分页获取所有operation信息", notes = "获取所有operation信息",httpMethod = "GET")
    @ApiImplicitParams({
