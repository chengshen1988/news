...
public class OrgController {
    ...
    */
    @ApiOperation(value = "保存数据", notes = "保存数据到Org",httpMethod = "POST")
     ...
     */
    @ApiOperation(value = "删除数据", notes = "根据主键id删除Org数据",httpMethod = "DELETE")
    @DeleteMapping(value = "/deleteById/orgId", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ReturnModel deleteById(@ApiParam(name = "orgId",value = "org主键id")
    ...
    */
    @ApiOperation(value = "更新数据", notes = "根据主键id更新Org数据",httpMethod = "PUT")
    @PutMapping(value = "/updateById/orgId", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    */
    @ApiOperation(value = "获取单条数据", notes = "根据主键id获取Org数据",httpMethod = "GET")
    @GetMapping(value = "/selectById/orgId", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ReturnModel selectById(@RequestParam(value = "orgId")  String orgId) {
     ...
     */
    @ApiOperation(value = "分页获取所有org信息", notes = "获取所有org信息",httpMethod = "GET")
    @ApiImplicitParams({
