...
public class SequenceController {
    ...
    private final Logger logger=LoggerFactory.getLogger(SequenceController.class);
    @Resource
    ...
    * @return 是否添加成功
    */
    @ApiOperation(value = "保存数据", notes = "保存数据到Sequence")
    ...
    public ReturnModel save(@RequestBody SequenceForm sequenceForm) {
        ...
        return ReturnModel.newSuccessInstance(sequenceForm);
    }
     ...
     * @return 是否删除成功
     */
    @ApiOperation(value = "删除数据", notes = "根据主键id删除Sequence数据")
    @PostMapping(value = "/deleteById", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ReturnModel deleteById(@RequestParam(required = true, value = "sequenceId") String sequenceId) {
    ...
    * @return 是否更改成功
    */
    @ApiOperation(value = "更新数据", notes = "根据主键id更新Sequence数据")
    ...
    * @return 查询结果
    */
    @ApiOperation(value = "获取单条数据", notes = "根据主键id获取Sequence数据")
    @GetMapping(value = "/selectById", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ReturnModel selectById(@RequestParam(required = true, value = "sequenceId") String sequenceId) {
     ...
     * @return
     */
    @ApiOperation(value = "分页获取所有sequence信息", notes = "获取所有sequence信息")
    @ApiImplicitParams({
