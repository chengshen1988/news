...
public interface GroupService extends IService<Group> {
    ...
    * @return 影响记录数
    */
    Integer updateById(GroupForm record);
    ...
    * @return
    */
    IPage<GroupVo> selectPage(GroupQuery groupQuery);
     ...
     * @return
     */
    List<GroupVo> selectList(GroupQuery groupQuery);
    ...
    * @param groupQuery 前台传值的query对象
    */
    QueryWrapper<Group> getQueryWrapper(QueryWrapper<Group> queryWrapper,GroupQuery groupQuery);
