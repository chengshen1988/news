...
public interface LogExceptionService extends IService<LogException> {
    ...
    * @return 影响记录数
    */
    Integer save(LogExceptionForm record);
    ...
    * @return 影响记录数
    */
    Integer updateById(LogExceptionForm record);
    ...
    * @return 信息对象
    */
    LogExceptionVo selectById(String id);

    /**
    *  分页查询
    * @param logExceptionQuery
    * @return
    */
    IPage<LogExceptionVo> selectPage(LogExceptionQuery logExceptionQuery);
     ...
     * @return
     */
    List<LogExceptionVo> selectList(LogExceptionQuery logExceptionQuery);
    ...
    * @param logExceptionQuery 前台传值的query对象
    */
    QueryWrapper<LogException> getQueryWrapper(QueryWrapper<LogException> queryWrapper,LogExceptionQuery logExceptionQuery);
