...
public interface MenuService extends IService<Menu> {
    ...
    * @return
    */
    IPage<MenuVo> selectPage(MenuQuery menuQuery);
     ...
     * @return
     */
    List<MenuVo> selectList(MenuQuery menuQuery);
    ...
    * @param menuQuery 前台传值的query对象
    */
    QueryWrapper<Menu> getQueryWrapper(QueryWrapper<Menu> queryWrapper,MenuQuery menuQuery);
