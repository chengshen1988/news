...
public interface MessageUserService extends IService<MessageUser> {
    ...
    * @return 影响记录数
    */
    Integer save(MessageUserForm record);
    ...
    * @return 影响记录数
    */
    Integer updateById(MessageUserForm record);
    ...
    * @return 信息对象
    */
    MessageUserVo selectById(String id);
    ...
    * @return
    */
    IPage<MessageUserVo> selectPage(MessageUserQuery messageUserQuery);
     ...
     * @return
     */
    List<MessageUserVo> selectList(MessageUserQuery messageUserQuery);
    ...
    * @param messageUserQuery 前台传值的query对象
    */
    QueryWrapper<MessageUser> getQueryWrapper(QueryWrapper<MessageUser> queryWrapper,MessageUserQuery messageUserQuery);
