...
public interface NoticeService extends IService<Notice> {
    ...
    * @return 影响记录数
    */
    Integer save(NoticeForm record);
    ...
    * @return 影响记录数
    */
    Integer updateById(NoticeForm record);
    ...
    * @return
    */
    IPage<NoticeVo> selectPage(NoticeQuery noticeQuery);
     ...
     * @return
     */
    List<NoticeVo> selectList(NoticeQuery noticeQuery);
    ...
    * @param noticeQuery 前台传值的query对象
    */
    QueryWrapper<Notice> getQueryWrapper(QueryWrapper<Notice> queryWrapper,NoticeQuery noticeQuery);
