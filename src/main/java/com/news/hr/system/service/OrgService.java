...
public interface OrgService extends IService<Org> {
    ...
    * @return 影响记录数
    */
    Integer updateById(OrgForm record);
    ...
    * @return
    */
    IPage<OrgVo> selectPage(OrgQuery orgQuery);
     ...
     * @return
     */
    List<OrgVo> selectList(OrgQuery orgQuery);
    ...
    * @param orgQuery 前台传值的query对象
    */
    QueryWrapper<Org> getQueryWrapper(QueryWrapper<Org> queryWrapper,OrgQuery orgQuery);
