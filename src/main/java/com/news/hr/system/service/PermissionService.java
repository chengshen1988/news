...
public interface PermissionService extends IService<Permission> {
    ...
    * @return 影响记录数
    */
    Integer save(PermissionForm record);
    ...
    * @return 影响记录数
    */
    Integer updateById(PermissionForm record);
    ...
    * @return
    */
    IPage<PermissionVo> selectPage(PermissionQuery permissionQuery);
     ...
     * @return
     */
    List<PermissionVo> selectList(PermissionQuery permissionQuery);
    ...
    * @param permissionQuery 前台传值的query对象
    */
    QueryWrapper<Permission> getQueryWrapper(QueryWrapper<Permission> queryWrapper,PermissionQuery permissionQuery);
