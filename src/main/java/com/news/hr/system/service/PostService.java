...
public interface PostService extends IService<Post> {
    ...
    * @return 影响记录数
    */
    Integer updateById(PostForm record);
    ...
    * @return
    */
    IPage<PostVo> selectPage(PostQuery postQuery);
     ...
     * @return
     */
    List<PostVo> selectList(PostQuery postQuery);
    ...
    * @param postQuery 前台传值的query对象
    */
    QueryWrapper<Post> getQueryWrapper(QueryWrapper<Post> queryWrapper,PostQuery postQuery);
