...
public interface RegionService extends IService<Region> {
    ...
    * @return 影响记录数
    */
    Integer save(RegionForm record);
    ...
    * @return 影响记录数
    */
    Integer updateById(RegionForm record);
    ...
    * @return
    */
    IPage<RegionVo> selectPage(RegionQuery regionQuery);
     ...
     * @return
     */
    List<RegionVo> selectList(RegionQuery regionQuery);
    ...
    * @param regionQuery 前台传值的query对象
    */
    QueryWrapper<Region> getQueryWrapper(QueryWrapper<Region> queryWrapper,RegionQuery regionQuery);
