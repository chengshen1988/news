...
public interface UserGroupService extends IService<UserGroup> {
    ...
    * @return 影响记录数
    */
    Integer save(UserGroupForm record);
    ...
    * @return 影响记录数
    */
    Integer updateById(UserGroupForm record);
    ...
    * @return 信息对象
    */
    UserGroupVo selectById(String id);
    ...
    * @return
    */
    IPage<UserGroupVo> selectPage(UserGroupQuery userGroupQuery);
     ...
     * @return
     */
    List<UserGroupVo> selectList(UserGroupQuery userGroupQuery);
    ...
    * @param userGroupQuery 前台传值的query对象
    */
    QueryWrapper<UserGroup> getQueryWrapper(QueryWrapper<UserGroup> queryWrapper,UserGroupQuery userGroupQuery);
